    ...
    <div class="tw-flex tw-gap-8">
        <div class="tw-basis-2/6 tw-flex tw-flex-col tw-gap-4">
            ...
            <div class="form-group">
                ...
                <small class="form-text text-muted">You can set the schedule in cron format to fetch the bank APIs differently from the WHMCS Cron. Default value is <strong>* * * * *</strong>. You can set for example <strong>* 8,11,15,19 * * *</strong> to only fetch APIs of GoCardless 4 times a day (results are cached up to 1 hour), lowering the possibility of suspension in case of API failures.</small>
            </div>
        </div>
        <div class="tw-flex tw-flex-col tw-grow">
            <div>
                <h2>Data mapping</h2>
                <p>Map the values from your bank's API. Date, unique reference is mandatory, the transaction's amount is a fixed field. Description of the fields is available <a href="https://developer.gocardless.com/bank-account-data/transactions" target="_blank">here</a>.</p>
            </div>
            <div class="form-group">
